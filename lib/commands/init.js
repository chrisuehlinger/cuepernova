...
export async function initProject(options) {
  ...
  const directories = ['public', 'public/cueballs', 'public/media', 'public/css', 'public/js'];
  const files = [
    { src: 'db.json', dest: 'db.json' },
    { src: 'cueballs/example.html', dest: 'public/cueballs/example.html' },
    { src: 'media/.gitkeep', dest: 'public/media/.gitkeep' }
  ];
  ...
  if (existsSync(join(projectRoot, 'db.json'))) {
    existingItems.push('db.json');
  }
